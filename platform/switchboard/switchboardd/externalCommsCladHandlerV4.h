/**
 * File: externalCommsCladHandlerV4.h
 *
...
namespace Switchboard {
  class ExternalCommsCladHandlerV4 {
    public:
    using RtsConnectionSignal = Signal::Signal<void (const Anki::Vector::ExternalComms::RtsConnection_4& msg)>;
    ...
    Anki::Vector::ExternalComms::ExternalComms ReceiveExternalCommsMsg(uint8_t* buffer, size_t length) {
      ...
      if(extComms.GetTag() == Anki::Vector::ExternalComms::ExternalCommsTag::RtsConnection) {
        ...
        Anki::Vector::ExternalComms::RtsConnection_4 rtsMsg = rstContainer.Get_RtsConnection_4();
