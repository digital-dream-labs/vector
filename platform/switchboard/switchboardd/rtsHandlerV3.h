...
private:
  ...
  void HandleRtsConnResponse(const Vector::ExternalComms::RtsConnection_3& msg);

  Signal::SmartHandle _rtsChallengeMessageHandle;
  void HandleRtsChallengeMessage(const Vector::ExternalComms::RtsConnection_3& msg);

  Signal::SmartHandle _rtsWifiConnectRequestHandle;
  void HandleRtsWifiConnectRequest(const Vector::ExternalComms::RtsConnection_3& msg);

  Signal::SmartHandle _rtsWifiIpRequestHandle;
  void HandleRtsWifiIpRequest(const Vector::ExternalComms::RtsConnection_3& msg);

  Signal::SmartHandle _rtsRtsStatusRequestHandle;
  void HandleRtsStatusRequest(const Vector::ExternalComms::RtsConnection_3& msg);

  Signal::SmartHandle _rtsWifiScanRequestHandle;
  void HandleRtsWifiScanRequest(const Vector::ExternalComms::RtsConnection_3& msg);

  Signal::SmartHandle _rtsWifiForgetRequestHandle;
  void HandleRtsWifiForgetRequest(const Vector::ExternalComms::RtsConnection_3& msg);

  Signal::SmartHandle _rtsOtaUpdateRequestHandle;
  void HandleRtsOtaUpdateRequest(const Vector::ExternalComms::RtsConnection_3& msg);

  Signal::SmartHandle _rtsOtaCancelRequestHandle;
  void HandleRtsOtaCancelRequest(const Vector::ExternalComms::RtsConnection_3& msg);

  Signal::SmartHandle _rtsWifiAccessPointRequestHandle;
  void HandleRtsWifiAccessPointRequest(const Vector::ExternalComms::RtsConnection_3& msg);

  Signal::SmartHandle _rtsCancelPairingHandle;
  void HandleRtsCancelPairing(const Vector::ExternalComms::RtsConnection_3& msg);

  Signal::SmartHandle _rtsAckHandle;
  void HandleRtsAck(const Vector::ExternalComms::RtsConnection_3& msg);
