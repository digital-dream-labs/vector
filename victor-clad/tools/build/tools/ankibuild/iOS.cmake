# found https://code.google.com/p/ios-cmake/source/browse/toolchain/iOS.cmake
...
if (${IOS_PLATFORM} STREQUAL "OS")
    set (CMAKE_OSX_SYSROOT "iphoneos" CACHE PATH "Sysroot used for iOS support")
elseif (${IOS_PLATFORM} STREQUAL "OS")
    set (CMAKE_OSX_SYSROOT "iphonesimulator" CACHE PATH "Sysroot used for iOS support")
endif (${IOS_PLATFORM} STREQUAL "OS")
...
set (CMAKE_FIND_ROOT_PATH ${CMAKE_IOS_DEVELOPER_ROOT} ${CMAKE_IOS_SDK_ROOT} CACHE string  "iOS find search path root")
